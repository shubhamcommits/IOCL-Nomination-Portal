        ...
        <div class="banner" id="home">
            <div class="agileinfo-dot">
                        ...
                        <nav class="navbar navbar-default navbar-fixed-top">
                            <div class="navbar-header page-scroll">
                                ...
                                <h1><a class="navbar-brand" href="index.html">
                                    <img src="unnamed-4.png" width="60px" height="60px" align="left"></a> </h1>
                            </div>
                    ...
                    <div class="about">
                        ...
                        <div class="w3_banner_info_grid">
                            ...
                            <div class="market-updates row">
                                <asp:LinkButton ID="form5" runat="server" OnClick="form5_Click"><div class="col-md-4 col-xs-12 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-4 market-update-right">
						<i class="fa fa-file-text-o" ></i>
					</div>
					<div class="col-md-12 market-update-left text-left">
					<!--<h4>Form 5</h4>-->
						<h5 style="color:white;">Indian Oil Employees Welfare Co-Op. Society</h5>
				  ...
				  <div class="clearfix"> </div>
                                ...
                                <asp:LinkButton ID="form2" runat="server" OnClick="form2_Click"><div class="col-md-4 col-xs-12 market-update-gd">
				<div class="market-update-block clr-block-3">
					...
					<h4></h4>
						<h5 style="color:white;">Superannuation Benefit Fund Scheme</h5>
						<p style="color:white;"><b></b></p>
					</div>
				  <div class="clearfix"> </div>
				</div>
				...
				<div class="market-update-block clr-block-1">
					...
					<div class="col-md-12 market-update-left">
					<h4></h4>
						<h5 style="color:white;">For Amount due other than graudity and PF</h5>
                        <p style="color:white;"><b></b></p> 
				  ...
				  <div class="clearfix"> </div>
                            ...
                            <div class="market-updates row">
                                <asp:LinkButton ID="form4" runat="server" OnClick="form4_Click"><div class="col-md-3 col-xs-12 market-update-gd">
				<div class="market-update-block clr-block-3">
					<div class="col-md-4 market-update-right">
						<i class="fa fa-file-text-o"></i>
					</div>
					<div class="col-md-12 market-update-left">
						<!--<h4>Form 4</h4>-->
						<h5 style="color:white;">EPS '95 Form 2(Revised)</h5>
						<p style="color:white;"><b></b></p>
					</div>
				  <div class="clearfix"> </div>
				</div>
                                ...
                                <div class="col-md-3 col-xs-12 market-update-gd">
                                    <div class="market-update-block clr-block-1">
                                        <div class="col-md-4 market-update-right">
                                            <i class="fa fa-file-text-o"></i>
                                        </div>
                                        <div class="col-md-12 market-update-left">
                                            ...
                                            <h5 style="color: white;">Employees' Gratuity Scheme</h5>
                                ...
                                <asp:LinkButton ID="form6" runat="server" OnClick="form6_Click"><div class="col-md-3 col-xs-12 market-update-gd">
				<div class="market-update-block clr-block-3">
					<div class="col-md-4 market-update-right">
						<i class="fa fa-file-text-o"></i>
					</div>
					<div class="col-md-12 market-update-left">
						<!--<h4>6</h4>-->
						<h5 style="color:white;">EPF Declaration Form Rule 10</h5>
						<p style="color:white;"><b></b>
						 </p>
					</div>
				  <div class="clearfix"> </div>
                                ...
                                <asp:LinkButton ID="form7" runat="server" OnClick="form7_Click"><div class="col-md-3 col-xs-12 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-4 market-update-right">
						<i class="fa fa-file-text-o" ></i>
					</div>
					<div class="col-md-12 market-update-left">
					<!--<h4></h4>-->
						<h5 style="color:white;">Appointment of Beneficiary</h5>
						<p style="color:white;"><b></b></p>
					</div>
				  <div class="clearfix"> </div>
				</div>
                                    ...
                                    <li>
                                        <ul class="agileits-address-text">
                                            ...
                                            <li>
                                                ...
                                                <p>
                                                    <center><input type="checkbox" required name="terms"> I hereby declare that I have understood the above information. &nbsp;</center>
                                                </p>
        ...
        <div class="copyright-agile">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="unnamed-4.png" width="70px" height="45px" align="left"></a>
