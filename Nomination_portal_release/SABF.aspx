<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SABF.aspx.cs" Inherits="Nomination_Portal.WebForm9" %>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
  ...
  <li><a href="#">Final Submission</a></li>
	...
	<h3 data-aos="zoom-in">SUPER-ANNUATION BENEFIT FUND SCHEME</h3>
        ...
        <table style="width: 100%;" caption-side="Add New Nomination"  class="table-bordered table" >
            ...
            <tr>
                ...
                <td class="auto-style1 text-left">
                    <asp:DropDownList ID="relation_drop" runat="server"  Width="210px" CssClass="auto-style1">
            ...
            <tr>
                <td colspan="2" class="text-center"><asp:Button ID="button_add_nomination" runat="server" Text="Add Nomination" BackColor="#ef7e3e" ForeColor="#000000"  OnClick="Button1_Click" CssClass="btn-lg"  /> &nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="button_clear" runat="server" Text="Clear" BackColor="#ef7e3e" ForeColor="#000000" CssClass="btn-lg"  /></td>
            </tr>
        </table>
