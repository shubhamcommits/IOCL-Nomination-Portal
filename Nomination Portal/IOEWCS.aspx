<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IOEWCS.aspx.cs" Inherits="Nomination_Portal.WebForm3" %>
<!DOCTYPE html>
<script runat="server">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
  ...
  <li><a href="#">Final Submission</a></li>
	...
	<h3 data-aos="zoom-in">INDIAN OIL EMPLOYEES' WELFARE CO-OP SOCIETY LTD.</h3>
   ...
   <center> <asp:Button ID="button_back" runat="server" Text="Back" BackColor="#212A4F" ForeColor="White" CssClass="btn-lg" OnClick="button_back_Click" PostBackUrl="~/front.aspx"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="button_save" runat="server" Text="Save and Proceed" ForeColor="White" BackColor="#212a4f" CssClass="btn-lg" OnClick="Button2_Click"></asp:Button>&nbsp; <!--<a href="#" class="w3ls_more" data-toggle="modal" data-target="#myModal">READ INSTRUCTIONS & PROCEED</a>-->
                        ...
                        <asp:Button ID="Button8" runat="server" Text="Submit" OnClick="Button8_Click" CssClass="btn-lg text-center" BackColor="#212A4F" ForeColor="White" /> 
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btn_print" runat="server" BackColor="#212A4F" CssClass="btn-lg text-center" ForeColor="White" OnClick="Button8_Click" Text="PRINT" Visible="false" />
                            </div>
                        </asp:View>
